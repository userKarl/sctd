$(function() {
	...
	var width=screenWidth/6*1;
	$('input.labelauty + label > span.labelauty-checked-image').css('width',width+'em');
	$('input.labelauty + label > span.labelauty-unchecked-image').css('width',width+'em');
	$('#button').click(
			function() {
