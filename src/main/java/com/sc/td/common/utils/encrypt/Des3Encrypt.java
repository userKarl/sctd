package com.sc.td.common.utils.encrypt;
...
public class Des3Encrypt {
	// 密钥
	private final static String secretKey = "adminSC@mix@lx100$#365#$";
	// 向量
	...
	public static void main(String[] args) throws Exception {
		String text = "123456";
		String encode = Des3Encrypt.encode(text, "adminSC@mix@lx100$#365#$", "0F5E3A24");
		System.out.println("加密：" + encode);
		String decode = Des3Encrypt.decode(encode, "adminSC@mix@lx100$#365#$", "0F5E3A24");
		System.out.println("解密：" + decode);
		System.out.println(DigestUtils.md5Hex(encode));
