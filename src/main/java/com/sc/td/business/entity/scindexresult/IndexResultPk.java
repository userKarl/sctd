...
public class IndexResultPk implements Serializable {

	/**
	 * 唯一标识
	 */
	private static final long serialVersionUID = -9113053727949001880L;

	public IndexResultPk() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IndexResultPk other = (IndexResultPk) obj;
		if (commodityNo == null) {
